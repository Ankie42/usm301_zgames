...
<html lang="en">
  ...
  <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-warning">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{route('home')}}">Z games</a>
                    <img class="logo" src="{{asset('img/jazz.jpg')}}">
                    <!--asset()= accede a public con php(donde estaran los asstes) -->
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link active" aria-current="page" href="{{route('home')}}">Agrega consola</a>
    ...
    <!--Se hace una seccion para usarse !-->
    @yield("javascript")
